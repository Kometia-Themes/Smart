$(function() {
  ...
  var navigation = $('.navbar.navbar-fixed-top.navigation');
  var slider = $('.featured-slider-home');
  var slider_content = $('.featured-slider-home__content');
  var limit = 400;
  ...
  // Get selected value
  $( "select.js-select-orderby" ).change(function() {
