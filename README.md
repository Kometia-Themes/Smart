...
1. [Descargar] (https://github.com/Shoperti-Themes/Smart/archive/master.zip) la última versión de la rama master.
2. También puedes clonar el repositorio con git: <code>git clone git@github.com:Shoperti-Themes/Smart.git</code>

![alt text](https://raw.githubusercontent.com/Shoperti-Themes/Smart/master/screenshot.png "Screeshot")
